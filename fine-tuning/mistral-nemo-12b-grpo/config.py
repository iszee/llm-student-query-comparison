...
config.py
---------
Central configuration for Mistral Nemo 12B GRPO + LoRA (BF16) fine-tuning.
...
class Config:
    ...
    output_dir: str = "fine-tuning/mistral-nemo-12b-grpo/checkpoints"
    ...
    use_vllm: bool = True
    vllm_gpu_memory_utilization: float = 0.35   # ~28 GB on H100 79 GB
