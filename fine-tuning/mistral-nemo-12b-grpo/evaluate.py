...
evaluate.py
-----------
Evaluate Mistral Nemo 12B across all 8 configurations by default:
...
Usage:
    ...
    # Specific checkpoint
    python fine-tuning/mistral-nemo-12b-grpo/evaluate.py \\
        --checkpoint fine-tuning/mistral-nemo-12b-grpo/checkpoints/checkpoint-100
...
Requires env vars:
    HF_TOKEN        — gated Mistral Nemo weights on HuggingFace Hub
...
def load_model_and_tokenizer(checkpoint: str | None, cfg: Config):
    """
    Load base Mistral Nemo 12B in BF16 + optional LoRA adapter.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Evaluate Mistral Nemo 12B across all 8 configurations: "
    ...
    parser.add_argument(
        "--checkpoint",
        default="fine-tuning/mistral-nemo-12b-grpo/checkpoints/final",
        help=(
    ...
    parser.add_argument(
        "--output-dir",
        default="fine-tuning/mistral-nemo-12b-grpo/results",
        help=(
